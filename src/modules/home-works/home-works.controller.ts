...
export class HomeWorksController {
  ...
  // ─── CREATE ──────────────────────────────────────────────────────────────
  @ApiOperation({ summary: 'Yangi uyga vazifa yaratish (ADMIN, SUPERADMIN, TEACHER)' })
  ...
  // ─── GURUHGA TEGISHLI ─────────────────────────────────────────────────────
  @ApiOperation({ summary: 'Guruhga tegishli uyga vazifalar (ADMIN, SUPERADMIN, TEACHER)' })
  @Roles(UserRole.SUPERADMIN, UserRole.ADMIN, UserRole.TEACHER)
  @Get('group/:groupId')
  findAllByGroup(
  ...
  @ApiOperation({ summary: 'Homework topshiriqlarini ko\'rish (TEACHER, ADMIN, SUPERADMIN)' })
  @Roles(UserRole.SUPERADMIN, UserRole.ADMIN, UserRole.TEACHER)
  ...
  @ApiOperation({ summary: 'Bitta student topshirig\'ini ko\'rish (TEACHER, ADMIN, SUPERADMIN)' })
  @Roles(UserRole.SUPERADMIN, UserRole.ADMIN, UserRole.TEACHER)
  ...
  getStudentSubmission(
    ...
    return this.homeWorksService.getStudentSubmission(hwId, studentId, req['user']);
  }

  // ─── BAHOLASH ────────────────────────────────────────────────────────────
  @ApiOperation({ summary: 'Topshiriqni baholash (TEACHER, ADMIN, SUPERADMIN)' })
  @Roles(UserRole.SUPERADMIN, UserRole.ADMIN, UserRole.TEACHER)
  ...
  @ApiOperation({ summary: 'Student uyga vazifa topshiradi (STUDENT, TEACHER, ADMIN)' })
  ...
  submitHomework(
    ...
    return this.homeWorksService.submitHomework(hwId, studentId, dto.comment, fileNames);
  }
  ...
  // ─── O'CHIRISH ────────────────────────────────────────────────────────────
  @ApiOperation({ summary: "Uyga vazifani o'chirish (ADMIN, SUPERADMIN, TEACHER)" })
  @Roles(UserRole.SUPERADMIN, UserRole.ADMIN, UserRole.TEACHER)
  @Delete(':id')
